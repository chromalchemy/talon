...
Plugins Panel: user.menu_select('Plugins|Plugins Panel')
Browse Plugins: user.menu_select('Plugins|Browse Plugins...')
Manage Plugins..: user.menu_select('Plugins|Manage Plugins..')
ProStacker: user.menu_select('Plugins|ProStacker|ProStacker')
Tile (all | windows) Vertically: user.menu_select('Window|Arrange|Tile All Vertically')
Tile (all | windows) Horizontally: user.menu_select('Window|Arrange|Tile All Horizontally')
[windows] 2 up Horizontal: user.menu_select('Window|Arrange|2-up Horizontal')
[windows] 2 up Vertical: user.menu_select('Window|Arrange|2-up Vertical')
[windows] 3 up Horizontal: user.menu_select('Window|Arrange|3-up Horizontal')
[windows] 3 up Vertical: user.menu_select('Window|Arrange|3-up Vertical')
[windows] 3 up Stacked: user.menu_select('Window|Arrange|3-up Stacked')
[windows] 4 uр: user.menu_select('Window|Arrange|4-uр')
6-up: user.menu_select('Window|Arrange|6-up')
(consolidate | windows) to Tabs: user.menu_select('Window|Arrange|Consolidate All to Tabs')
cascade windows: user.menu_select('Window|Arrange|Cascade')
Tile windows: user.menu_select('Window|Arrange|Tile')
Float in Window: user.menu_select('Window|Arrange|Float in Window')
Float All in Windows: user.menu_select('Window|Arrange|Float All in Windows')
Match Zoom: user.menu_select('Window|Arrange|Match Zoom')
Match Location: user.menu_select('Window|Arrange|Match Location')
Match Rotation: user.menu_select('Window|Arrange|Match Rotation')
Match All: user.menu_select('Window|Arrange|Match All')
Minimize [window]: user.menu_select('Window|Arrange|Minimize [window]')
windows to Front: user.menu_select('Window|Arrange|Bring All to Front')
...
Adjustments [panel]: user.menu_select('Window|Adjustments')
Beta Feedback [panel]: user.menu_select('Window|Beta Feedback')
Brush Settings [panel]: user.menu_select('Window|Brush Settings')
Brushes [panel]: user.menu_select('Window|Brushes')
Channels [panel]: user.menu_select('Window|Channels')
Character [panel]: user.menu_select('Window|Character')
Character Styles [panel]: user.menu_select('Window|Character Styles')
Clone Source [panel]: user.menu_select('Window|Clone Source')
Color panel [panel]: user.menu_select('Window|Color')
Comments [panel]: user.menu_select('Window|Comments')
Content Credentials (Beta) [panel]: user.menu_select('Window|Content Credentials (Beta)')
Glyphs [panel]: user.menu_select('Window|Glyphs')
Gradients [panel]: user.menu_select('Window|Gradients')
Histogram [panel]: user.menu_select('Window|Histogram')
History [panel]: user.menu_select('Window|History')
Info [panel]: user.menu_select('Window|Info')
Layer (Comps | compositions): user.menu_select('Window|Layer Comps')
Layers panel [panel]: user.menu_select('Window|Layers')
Libraries [panel]: user.menu_select('Window|Libraries')
Materials [panel]: user.menu_select('Window|Materials')
Measurement Log [panel]: user.menu_select('Window|Measurement Log')
Navigator [panel]: user.menu_select('Window|Navigator')
Notes [panel]: user.menu_select('Window|Notes')
Paragraph [panel]: user.menu_select('Window|Paragraph')
Paragraph Styles [panel]: user.menu_select('Window|Paragraph Styles')
Paths [panel]: user.menu_select('Window|Paths')
Patterns [panel]: user.menu_select('Window|Patterns')
Properties [panel]: user.menu_select('Window|Properties')
Shapes [panel]: user.menu_select('Window|Shapes')
Styles [panel]: user.menu_select('Window|Styles')
Swatches [panel]: user.menu_select('Window|Swatches')
Timeline [panel]: user.menu_select('Window|Timeline')
Tool Presets [panel]: user.menu_select('Window|Tool Presets')
Version History [panel]: user.menu_select('Window|Version History')
Application Frame [panel]: user.menu_select('Window|Application Frame')
Options [panel]: user.menu_select('Window|Options')
Tools [panel]: user.menu_select('Window|Tools')
Contextual Task Bar [panel]: user.menu_select('Window|Contextual Task Bar')